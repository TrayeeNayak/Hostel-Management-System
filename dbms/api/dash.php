...
if(isset($_SESSION['username'])) {
    ...
    $stmt = $con->prepare("SELECT SBRANCH, DOB, SEMAIL, SADDRESS, USN, SROOM, SPHONE, SSEM, SGENDER, FNAME, FPHONE, MNAME, SRELIGION, INTAKE_DATE, HOSTEL_ID, PROFILE FROM student WHERE SNAME = ?");
    ...
    $stmt->bind_result($sbranch, $dob, $semail, $saddress, $usn, $sroom, $sphone, $ssem, $sgender, $fname, $fphone, $mname, $sreligion, $intake_date, $hid, $profile_picture_filename);
...
<body>
    ...
    <header>
        ...
        <div class="theme-toggler">
            <span class="material-icons-sharp active">light</span>
            <span class="material-icons-sharp">dark</span>
        </div>
            ...
            <div class="profile">
                <div class="top">
                    ...
                    <?php if (!empty($profile_picture_filename)): ?>
                     <img src="./upload/<?php echo $profile_picture_filename; ?>" alt="Profile Picture">
                      <?php endif; ?>
                    </div>
                    ...
                    <div class="info">
                        ...
                        <small class="text-muted"><?php echo $sphone; ?></small>
                    </div>
