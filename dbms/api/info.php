...
<head>
    ...
    <title>Female Student Information</title>
    <style>
...
<header class="header">
        ...
        <div class="navbar">
            <a href="./warden.php" class="active">
...
<table class="content-tables">
    ...
    <tbody>
        ...
        // Prepare and execute the query to fetch female student details
        $sql = "SELECT * FROM student WHERE SGENDER = 'f'";
        $result = $con->query($sql);

        if ($result->num_rows > 0) {
            // Output data of each female student
            ...
            echo "<tr><td colspan='13'>No female students found</td></tr>";
        }
        $con->close();
        ?>
        </tr>
